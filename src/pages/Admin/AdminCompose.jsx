...
const contentTemplates = [
    ...
    },
    {
        ...
        category_code: 'guide',
        post_type: 'guide',
        title: '校园网怎么连？这篇先收藏，开学后持续更新',
        content: '校园网账号、认证方式、宿舍网络覆盖和常见问题，需要以学校信息中心或辅导员最新通知为准。开学后如果你遇到连不上、认证失败、网速异常，可以在评论区描述设备和报错，深汕e仔会整理成排查清单。',
        sort_weight: 170,
    },
    {
        name: '快递说明',
        ...
        category_code: 'life',
        post_type: 'guide',
        title: '开学快递怎么寄？先别急，等官方点位确认',
        content: '新校区快递点、收件地址、取件时间可能会在开学前后更新。建议大件物品不要太早寄出，等学校公布宿舍楼、快递点和取件安排后再下单。深汕e仔会把确认后的公开信息整理到这里。',
        sort_weight: 165,
    },
    {
        name: '军训提醒',
        ...
        category_code: 'guide',
        post_type: 'guide',
        title: '军训安排先看这里：哪些信息需要等学校确认？',
        content: '军训时间、地点、服装发放、请假流程等请以学校正式通知为准。开学前可以先准备防晒、舒适鞋垫、水杯、常用药等基础物品。确认消息出来后，深汕e仔会更新成一篇完整清单。',
        sort_weight: 160,
    },
    {
        name: '社团招新入口',
        ...
        category_code: 'club',
        post_type: 'club',
        title: '深汕校区社团/组织招新，可以先在这里集合',
        content: '如果你是社团、学生组织、兴趣小组负责人，可以在评论区留下招新方向、活动内容和后续联系方式。深汕e仔会把靠谱信息整理成社团招新合集，方便新生一次看完。',
        sort_weight: 150,
    },
    {
        name: '失物招领模板',
        ...
        content: '建议写清：丢失/捡到、物品名称、时间、地点、特征、联系方式。不要公开身份证号、完整手机号、宿舍号等隐私信息，必要时可以让对方通过评论补充特征确认。',
        sort_weight: 140,
    },
];
